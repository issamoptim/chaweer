...
export function GoogleButton({ onClick, disabled, loading }: GoogleButtonProps) {
  ...
  const handleClick = () => {
    if (isRedirecting || loading || disabled) return;
    setIsRedirecting(true);
    onClick?.();
  };

  const showSpinner = loading || isRedirecting;
