...
| Annuler / Enregistrer | إلغاء / حفظ | Cancel / Save |
| Retour | رجوع | Back |
| Le numéro de téléphone est utilisé pour votre authentification. | يُستخدم رقم الهاتف للمصادقة. | Your phone number is used for authentication. |
...
| Quitter cette page ? | مغادرة الصفحة؟ | Leave this page? |
